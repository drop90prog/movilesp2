export const saveComment = async (comment, iduser, avatar, chapterid, name)=> {
    ...
    let heroku = 'https://movilesp2.herokuapp.com/savecomment';
...
export const findComments = async(chapterid)=> {
    ...
    let heroku = 'https://movilesp2.herokuapp.com/findcomments'
...
export const updateComment = async (commentid, comment)=> {
    ...
    let heroku = 'https://movilesp2.herokuapp.com/updatecomment';
...
export const deleteComment = async (commentid)=> {
    ...
    let heroku = 'https://movilesp2.herokuapp.com/deletecomment'
